...
//            }
    ...
    public function sendOtpCode()
    {
        ...
        try {
            ...
            $title = ($title !== null || $title !== '') ? $title : 'BullionFX';
    ...
    public function sendOtpCodeEmail()
    {
        ...
        $companyName = isset($appTitle) && !empty($appTitle) ? $appTitle : __('BullionFX');
    ...
    public function twoFactorList($user)
    {
        try {
            ...
            if (in_array(GOOGLE_AUTH, $two_factor))
                $twoFactorArray[GOOGLE_AUTH] = getTwoFactorArray(GOOGLE_AUTH);
            if (in_array(EMAIL_AUTH, $two_factor))
                $twoFactorArray[EMAIL_AUTH] = getTwoFactorArray(EMAIL_AUTH);
            if (in_array(PHONE_AUTH, $two_factor))
                $twoFactorArray[PHONE_AUTH] = getTwoFactorArray(PHONE_AUTH);
        } catch (\Exception $e) {
